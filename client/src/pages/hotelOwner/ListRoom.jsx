...
const ListRoom = () => {
  ...
  //  toggleAvailability of the rooms, 
  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Room Listings"
        subTitle="View ,Edit or manage all listed rooms. Keep the information up to date to ensure a smooth booking experience for your users."
      />
      <p
        className="
      text-gray-500 mt-8"
